...
module.exports = {
	male: {
		...
		rule:	'$50$start$vowel$30$middle$10$middle$end'
	},
	female: {
		vowel: 	['a','e','i','o','u','y'],
		start: 	['Ad', 'Aer', 'Ar', 'Bel', 'Bet', 'Beth', 'Cen', 'Cyr', 'Eilin', 'El', 'Em', 'Emel', 'G', 'Gl', 'Glor', 'Is', 'Isl', 'Iv', 'Lay', 'Lis', 'May', 'Ner', 'Pol', 'Por', 'Sal', 'Sil', 'Vel', 'Vor', 'X', 'Xan', 'Xer', 'Yv', 'Zub'],
